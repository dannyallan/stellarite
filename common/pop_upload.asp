...
<%
	...
	strTitle 			= Application("IDS_UploadInfo")
		...
		Case "0"
			If blnUpload Then
				For i = 1 to intFiles
					...
					strStatus = Application("IDS_Success")

					strResultMsg = strResultMsg & "<span class=""hfont"">" & Application("IDS_FileName") & ": </span>" & strFileName & "<br>" & vbCrLf & _
							"<span class=""hfont"">" & Application("IDS_FileContent") & ": </span>" & strContentType & "<br>" & vbCrLf & _
							"<span class=""hfont"">" & Application("IDS_FileSize") & ": </span>" & lngFileSize & "<br>" & vbCrLf & _
							"<span class=""hfont"">" & Application("IDS_Status") & ": </span>" & strStatus & "<hr>" & vbCrLf & vbCrLf
...
<%
	Response.Write(getIconNew("pop_attach.asp?m=" & bytMod & "&mid=" & lngModId))
