...
<%
	...
	strTitle = getIDS("IDS_EditHomePage")
	...
	If strDoAction = "edit" Then
		...
		Call doRedirect(Application("av_CRMDir") & "main.asp")
	End If

	Call DisplayHeader(1)
	Call showEditHeader(strTitle,"","","","")
%>
<form name="frmAdmin" method="post" action="edit_portal.asp">
...
<% =getHidden("hdnChange","") %>
  <tr class="hRow">
	<td class="bFont" colspan=2><% =strFullName %></td>
  </tr>
<%
	For i = 0 to UBound(arrDisplay)
