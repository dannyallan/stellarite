...
<%
	...
	strTitle = getIDS("IDS_CRMStyleSheet")
	...
	Function chooseColor(fIDS,fName,fVal)
		chooseColor = getTextField(fName,"mRGB",fVal,17,7,"") & _
				...
				"<img src=""../images/color.gif"" alt=""" & getIDS("IDS_Import") & ": " & fIDS & """ border=0 height=16 width=16 /></a>"
	End Function
	...
	If strDoAction = "edit" Then
		...
		Call setAppVar("av_MajorColor",valString(Request.Form("txtMajorColor"),7,1,3))
		Call setAppVar("av_MinorColor",valString(Request.Form("txtMinorColor"),7,1,3))
		Call setAppVar("av_LinkStyle",valString(Request.Form("selLinkStyle"),15,1,0))
		Call setAppVar("av_VisitedStyle",valString(Request.Form("selVisitedStyle"),15,1,0))
		Call setAppVar("av_HoverStyle",valString(Request.Form("selHoverStyle"),15,1,0))
		Call setAppVar("av_PrintFont",valString(Request.Form("txtPrintFont"),150,1,0))
		Call setAppVar("av_PrintSize",valString(Request.Form("txtPrintSize"),5,1,0))
		Call setAppVar("av_LabelFont",valString(Request.Form("txtLabelFont"),150,1,0))
		Call setAppVar("av_LabelSize",valString(Request.Form("txtLabelSize"),5,1,0))
		Call setAppVar("av_LabelWeight",valString(Request.Form("selLabelWeight"),7,1,0))
		Call setAppVar("av_LabelColor",valString(Request.Form("txtLabelColor"),7,1,3))
		Call setAppVar("av_TitleFont",valString(Request.Form("txtTitleFont"),150,1,0))
		Call setAppVar("av_TitleSize",valString(Request.Form("txtTitleSize"),5,1,0))
		Call setAppVar("av_TitleWeight",valString(Request.Form("selTitleWeight"),7,1,0))
		Call setAppVar("av_TitleColor",valString(Request.Form("txtTitleColor"),7,1,3))
		Call setAppVar("av_HeaderFont",valString(Request.Form("txtHeaderFont"),150,1,0))
		Call setAppVar("av_HeaderSize",valString(Request.Form("txtHeaderSize"),5,1,0))
		Call setAppVar("av_HeaderWeight",valString(Request.Form("selHeaderWeight"),7,1,0))
		Call setAppVar("av_HeaderColor",valString(Request.Form("txtHeaderColor"),7,1,3))
		Call setAppVar("av_DefaultFont",valString(Request.Form("txtDefaultFont"),150,1,0))
		Call setAppVar("av_DefaultSize",valString(Request.Form("txtDefaultSize"),5,1,0))
		Call setAppVar("av_DefaultWeight",valString(Request.Form("selDefaultWeight"),7,1,0))
		Call setAppVar("av_DefaultColor",valString(Request.Form("txtDefaultColor"),7,1,3))
		Call setAppVar("av_DefaultAltBG",valString(Request.Form("txtDefaultAltBG"),7,1,3))
		Call setAppVar("av_DefaultHiBG",valString(Request.Form("txtDefaultHiBG"),7,1,3))
		Call setAppVar("av_FormEnabled",valString(Request.Form("txtFormEnabled"),7,1,3))
		Call setAppVar("av_FormDisabled",valString(Request.Form("txtFormDisabled"),7,1,3))
		Call setAppVar("av_FormMandatory",valString(Request.Form("txtFormMandatory"),7,1,3))
	...
	strIncHead = "<script language=""JavaScript"" type=""text/javascript"" src=""../common/editor/dialog.js""></script>" & vbCrLf & _
					"<script language=""JavaScript"" type=""text/javascript"" src=""../common/editor/popupwin.js""></script>"

	Call DisplayHeader(1)
	Call ShowEditHeader(strTitle,"","","","")
%>

<form name="frmAdmin" method="post" action="edit_style.asp">
